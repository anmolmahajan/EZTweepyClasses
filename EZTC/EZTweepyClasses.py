...
class EZTweepyClass:
    ...
    class KeyWordSearcher:
        def __init__(self, keyword, api, number_of_results=NUM_TWEETS):
            ...
            try:
                ...
                for tweet in tweets:
                    if(tweet.id in self.results):
                        ...
                        text = self.format_tweet(tweet.full_text)
    ...
    class AccountTweetBuilder:
        def __init__(self, username, api, number_of_results=NUM_TWEETS):
